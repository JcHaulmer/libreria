<div class="container-fluid mb-4 contenidoVista text-center">
    ...
    <h2 class="lead">Listar Editoriales</h2>
</div>
...
<div class="container py-6 contenidoVista">
    ...
    <?php
        ...
        if(!isset($_SESSION[$url[0]]) || empty($_SESSION[$url[0]])) { 
            echo $insEditorial->listarEditorialControlador($url[1],10,$url[0],""); 
        } else {
            echo $insEditorial->listarEditorialControlador($url[1],10,$url[0],$_SESSION[$url[0]]);
        }
    ?>
</div>