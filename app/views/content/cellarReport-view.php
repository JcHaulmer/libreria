<div class="container-fluid mb-4 contenidoVista text-center">
    <h1 class="display-4 fw-bold">Informes</h1>
    <h2 class="lead">Informe de Bodegas</h2>
</div>
...
<div class="container py-6 contenidoVista">
    <?php
        ...
        $insInformes = new reportController();
    ...
    <?php
        ...
        if(!isset($_SESSION[$url[0]]) || empty($_SESSION[$url[0]])) { 
            echo $insInformes->listarProductosPorBodegaControlador($url[1],10,$url[0],""); 
        } else {
            echo $insInformes->listarProductosPorBodegaControlador($url[1],10,$url[0],$_SESSION[$url[0]]);
        }
    ?>
</div>